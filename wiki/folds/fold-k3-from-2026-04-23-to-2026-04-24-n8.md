...
| 2026-04-23 | save | DragonScale Phase 1 - wiki-fold skill shipped | `skills/wiki-fold` (skill) | Wiki-fold shipped as a flat extractive rollup skill with dry-run stdout default, deterministic fold IDs, duplicate detection, and a 7/7 accept verdict. |
